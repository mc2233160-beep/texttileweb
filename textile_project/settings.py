"""
Django settings for textile_project project.
...
ROOT_URLCONF = "textile_project.urls"

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [BASE_DIR / "textile_project/templates"],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = "textile_project.wsgi.application"
